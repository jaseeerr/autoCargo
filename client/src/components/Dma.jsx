  ...
  return (
    <>
      <div className="mb-5 mt-5 p-2" ref={ref}>
        ...
        <div className="flex justify-between w-full">
          <div className="border-2 border-t-0 border-r-0 border-black w-full">
          ...
          <div className="flex justify-end border-b-2 border-l border-r-2 border-black w-96">
        ...
        <center>
          <table className="w-full bg-white border-2 border-black">
            <thead>
              <tr>
                <th className=" border-2 border-black"><p className="text-sm">Marks & Nos.</p></th>
